...
## 使用 tsreport-editor 進行 WYSIWYG 報表設計

[tsreport-editor](https://github.com/pontasan/tsreport-editor) 是以 tsreport-core 建構的 WYSIWYG 報表設計器。您可以在畫面上直觀配置帶區與元素、綁定 JSON 測試資料、檢查列印預覽、匯入 PDF，並以相同的 core 繪製引擎產生 PDF。以下影片展示 AI 透過 MCP 編輯報表，並在 Editor 中開啟完成版預覽的完整流程。

| 英文示範 | 日文示範 |
| --- | --- |
| [![英文版 tsreport-editor WYSIWYG 示範](https://img.youtube.com/vi/CHsNew6yQr4/hqdefault.jpg)](https://youtu.be/CHsNew6yQr4) | [![日文版 tsreport-editor WYSIWYG 示範](https://img.youtube.com/vi/0I3ljxLUbys/hqdefault.jpg)](https://youtu.be/0I3ljxLUbys) |
